...
import com.ebanking.blockchain.block.Block;
import com.ebanking.blockchain.util.ByteUtils;
...
public class ProofOfWork    {
    ...
    public PowResult run() {
        ...
        while (nonce < Long.MAX_VALUE) {
            ...
            shaHex = DigestUtils.md5DigestAsHex(data);
    ...
    public boolean validate() {
        ...
        return new BigInteger(DigestUtils.md5DigestAsHex(data), 16).compareTo(this.target) == -1;
    }
